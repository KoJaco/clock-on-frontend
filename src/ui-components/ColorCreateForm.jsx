...
export default function ColorCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setTextDark(initialValues.textDark);
    setErrors({});
  };
  const validations = {
    type: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Color(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ColorCreateForm")}
      {...rest}
    >
      <SelectField
        label="Type"
