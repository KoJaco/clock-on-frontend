                                    ...
                                    <div className="flex h-full w-full flex-col py-6">
                                        ...
                                        <div className="mb-6 flex w-full flex-shrink-0 ">
                                            ...
                                            <div className="flex w-full items-center justify-between gap-x-2 px-1 text-slate-700">
                                                <div className="flex">
                                                    {/* Expand / collapse narrow sidebar */}
                                                    <button
                                                        title="Expand or contract narrow sidebar"
                                                    ...
                                                    {/* Lock narrow sidebar === no hover effect */}
                                                    <button
                                                    ...
                                                    {/* <button
                                                        className={clsx(
                                                            'rounded-full py-1 px-2 hover:scale-105 shadow-lg border',
                                                            theme === 'dark'
